...
function conexao () {
    $conn = new \PDO('mysql:host=localhost; port=3306; dbname=boletoPHP','root','root' , array(
...
function dadosBoleto ($bancoId) {
    $conn = conexao();
    $query = "SELECT * FROM boletos WHERE id = $bancoId";
    $dadosBoleto = $conn->query($query)->fetchAll(PDO::FETCH_ASSOC);
    return $dadosBoleto;
}
// $dadosBoleto = dadosBoleto(1);
